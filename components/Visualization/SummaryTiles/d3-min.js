...
const d3 = Object.assign(
    {}, { min }, { max }, { range }, { extent }, { axisLeft },
    { axisBottom }, { format }, { scaleLinear }, { scaleSequential },
    { scaleBand }, { selection }, { select }, { selectAll },
    { transition }, { interpolateViridis }, { interpolateInferno },
    { interpolateMagma }, { interpolatePlasma },
);

// add interpolations and color schemes for chromatic scales
const sequentialChromatics = Object.keys(scaleChromatic)
